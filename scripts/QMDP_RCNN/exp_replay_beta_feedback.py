...
def belief_reward_backprop():
	...
	global time_index, backprop_belief, belief_target_actions
	...
	for act in range(0,action_size):
		...
		reward_estimate[act,:,:] = (1-alpha)*reward_estimate[act] -alpha * (qmdp_values_softmax[act]-belief_target_actions[act]) * backprop_belief[:,:]
