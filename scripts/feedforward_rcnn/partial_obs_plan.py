...
#Defining transition model and learnt transition model.
...
#Defining Bucket required for simulated model.
...
def back_prop_trans(action_index,time_index):
	...
	alpha = learning_rate - annealing_rate * (time_index/batch_size)
