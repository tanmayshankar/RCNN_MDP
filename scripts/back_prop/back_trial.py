...
#### Minimum version of back propagation to learn filter weights. 
basis_size = 3
discrete_size = 50
...
def reset_belief():
	...
	# max_val_location = npy.unravel_index(npy.argmax(target_belief),target_belief.shape)
